...
function NoteInputBar({onClickAdd, onClickSearch, isBeingSearch, notes}){
    return (
        <div className="note-app__input-bar-container">
            <div className="note-app__input-bar-option border-dashed border-2 border-black w-full rounded-lg bg-gray-100 h-72 inline-flex gap-5 justify-center items-center">
                ...
                <div className="text-center">
                    <button onClick={onClickSearch} className="p-3 rounded-full w-16 h-16" style={{ 
                        backgroundColor: '#DDDCFF'
